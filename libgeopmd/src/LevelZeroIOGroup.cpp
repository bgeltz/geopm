...
namespace geopm
{
    ...
    LevelZeroIOGroup::LevelZeroIOGroup(const PlatformTopo &platform_topo,
        ...
        , m_signal_available({{M_NAME_PREFIX + "GPU_CORE_FREQUENCY_STATUS", {
                              ...
                              {M_NAME_PREFIX + "GPU_RAS_RESET_COUNT_CORRECTABLE", {
                                  ...
                                  [this](unsigned int domain_idx) -> double
                                  {
                                      return this->m_levelzero_device_pool.ras_reset_count_correctable(
                                                   GEOPM_DOMAIN_GPU_CHIP,
                                                   domain_idx,
                                                   geopm::LevelZero::M_DOMAIN_ALL);
                                  },
                              ...
                              {M_NAME_PREFIX + "GPU_RAS_PROGRAMMING_ERRCOUNT_CORRECTABLE", {
                                  ...
                                  [this](unsigned int domain_idx) -> double
                                  {
                                      return this->m_levelzero_device_pool.ras_programming_errcount_correctable(
                                                   GEOPM_DOMAIN_GPU_CHIP,
                                                   domain_idx,
                                                   geopm::LevelZero::M_DOMAIN_ALL);
                                  },
                              ...
                              {M_NAME_PREFIX + "GPU_RAS_DRIVER_ERRCOUNT_CORRECTABLE", {
                                  ...
                                  [this](unsigned int domain_idx) -> double
                                  {
                                      return this->m_levelzero_device_pool.ras_driver_errcount_correctable(
                                                   GEOPM_DOMAIN_GPU_CHIP,
                                                   domain_idx,
                                                   geopm::LevelZero::M_DOMAIN_ALL);
                                  },
                              ...
                              {M_NAME_PREFIX + "GPU_RAS_COMPUTE_ERRCOUNT_CORRECTABLE", {
                                  ...
                                  [this](unsigned int domain_idx) -> double
                                  {
                                      return this->m_levelzero_device_pool.ras_compute_errcount_correctable(
                                                   GEOPM_DOMAIN_GPU_CHIP,
                                                   domain_idx,
                                                   geopm::LevelZero::M_DOMAIN_ALL);
                                  },
                              ...
                              {M_NAME_PREFIX + "GPU_RAS_NONCOMPUTE_ERRCOUNT_CORRECTABLE", {
                                  ...
                                  [this](unsigned int domain_idx) -> double
                                  {
                                      return this->m_levelzero_device_pool.ras_noncompute_errcount_correctable(
                                                   GEOPM_DOMAIN_GPU_CHIP,
                                                   domain_idx,
                                                   geopm::LevelZero::M_DOMAIN_ALL);
                                  },
                              ...
                              {M_NAME_PREFIX + "GPU_RAS_CACHE_ERRCOUNT_CORRECTABLE", {
                                  ...
                                  [this](unsigned int domain_idx) -> double
                                  {
                                      return this->m_levelzero_device_pool.ras_cache_errcount_correctable(
                                                   GEOPM_DOMAIN_GPU_CHIP,
                                                   domain_idx,
                                                   geopm::LevelZero::M_DOMAIN_ALL);
                                  },
                              ...
                              {M_NAME_PREFIX + "GPU_RAS_DISPLAY_ERRCOUNT_CORRECTABLE", {
                                  ...
                                  [this](unsigned int domain_idx) -> double
                                  {
                                      return this->m_levelzero_device_pool.ras_display_errcount_correctable(
                                                   GEOPM_DOMAIN_GPU_CHIP,
                                                   domain_idx,
                                                   geopm::LevelZero::M_DOMAIN_ALL);
                                  },
                              ...
                              {M_NAME_PREFIX + "GPU_RAS_RESET_COUNT_UNCORRECTABLE", {
                                  ...
                                  [this](unsigned int domain_idx) -> double
                                  {
                                      return this->m_levelzero_device_pool.ras_reset_count_uncorrectable(
                                                   GEOPM_DOMAIN_GPU_CHIP,
                                                   domain_idx,
                                                   geopm::LevelZero::M_DOMAIN_ALL);
                                  },
                              ...
                              {M_NAME_PREFIX + "GPU_RAS_PROGRAMMING_ERRCOUNT_UNCORRECTABLE", {
                                  ...
                                  [this](unsigned int domain_idx) -> double
                                  {
                                      return this->m_levelzero_device_pool.ras_programming_errcount_uncorrectable(
                                                   GEOPM_DOMAIN_GPU_CHIP,
                                                   domain_idx,
                                                   geopm::LevelZero::M_DOMAIN_ALL);
                                  },
                              ...
                              {M_NAME_PREFIX + "GPU_RAS_DRIVER_ERRCOUNT_UNCORRECTABLE", {
                                  ...
                                  [this](unsigned int domain_idx) -> double
                                  {
                                      return this->m_levelzero_device_pool.ras_driver_errcount_uncorrectable(
                                                   GEOPM_DOMAIN_GPU_CHIP,
                                                   domain_idx,
                                                   geopm::LevelZero::M_DOMAIN_ALL);
                                  },
                              ...
                              {M_NAME_PREFIX + "GPU_RAS_COMPUTE_ERRCOUNT_UNCORRECTABLE", {
                                  ...
                                  [this](unsigned int domain_idx) -> double
                                  {
                                      return this->m_levelzero_device_pool.ras_compute_errcount_uncorrectable(
                                                   GEOPM_DOMAIN_GPU_CHIP,
                                                   domain_idx,
                                                   geopm::LevelZero::M_DOMAIN_ALL);
                                  },
                              ...
                              {M_NAME_PREFIX + "GPU_RAS_NONCOMPUTE_ERRCOUNT_UNCORRECTABLE", {
                                  ...
                                  [this](unsigned int domain_idx) -> double
                                  {
                                      return this->m_levelzero_device_pool.ras_noncompute_errcount_uncorrectable(
                                                   GEOPM_DOMAIN_GPU_CHIP,
                                                   domain_idx,
                                                   geopm::LevelZero::M_DOMAIN_ALL);
                                  },
                              ...
                              {M_NAME_PREFIX + "GPU_RAS_CACHE_ERRCOUNT_UNCORRECTABLE", {
                                  ...
                                  [this](unsigned int domain_idx) -> double
                                  {
                                      return this->m_levelzero_device_pool.ras_cache_errcount_uncorrectable(
                                                   GEOPM_DOMAIN_GPU_CHIP,
                                                   domain_idx,
                                                   geopm::LevelZero::M_DOMAIN_ALL);
                                  },
                              ...
                              {M_NAME_PREFIX + "GPU_RAS_DISPLAY_ERRCOUNT_UNCORRECTABLE", {
                                  ...
                                  [this](unsigned int domain_idx) -> double
                                  {
                                      return this->m_levelzero_device_pool.ras_display_errcount_uncorrectable(
                                                   GEOPM_DOMAIN_GPU_CHIP,
                                                   domain_idx,
                                                   geopm::LevelZero::M_DOMAIN_ALL);
                                  },
        ...
        , m_mock_save_ctl(std::move(save_control_test))
    {
        ...
        register_signal_alias("GPU_CORE_FREQUENCY_MAX_CONTROL",
                              M_NAME_PREFIX + "GPU_CORE_FREQUENCY_MAX_CONTROL");
        register_signal_alias("GPU_RAS_COMPUTE_ERRCOUNT_CORRECTABLE", M_NAME_PREFIX + "GPU_RAS_COMPUTE_ERRCOUNT_CORRECTABLE");
        register_signal_alias("GPU_RAS_NONCOMPUTE_ERRCOUNT_CORRECTABLE", M_NAME_PREFIX + "GPU_RAS_NONCOMPUTE_ERRCOUNT_CORRECTABLE");
        register_signal_alias("GPU_RAS_COMPUTE_ERRCOUNT_UNCORRECTABLE", M_NAME_PREFIX + "GPU_RAS_COMPUTE_ERRCOUNT_UNCORRECTABLE");
        register_signal_alias("GPU_RAS_NONCOMPUTE_ERRCOUNT_UNCORRECTABLE", M_NAME_PREFIX + "GPU_RAS_NONCOMPUTE_ERRCOUNT_UNCORRECTABLE");
